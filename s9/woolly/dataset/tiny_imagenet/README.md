## How to get Tiny Imagenet Dataset

### Download and Restructure folders

copy the following code snippet to a `downloader.sh` file and run with the command `source downloader.sh`
...
This will download, extract and restructure the dataset

### Classes of tint-imagenet dataset
...
We will first load key names and their corresponding actual names from the tiny-imagenet dataset.
