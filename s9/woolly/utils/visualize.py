...
def plot_network_performance(
    epochs, schedule, train_loss, valid_loss, train_correct, valid_correct
):
    plt.figure(figsize=(15, 5))
...
def plot_model_comparison(trainers, epochs):
    ...
    plt.subplot(1, 2, 2)
    plt.plot(
        range(epochs), trainers[0].list_valid_correct, "b", label="BN + L1 Accuracy"
    )
